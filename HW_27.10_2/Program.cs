...
var third = new Book("Посібник. Алгебра 9", PublishingHouse_2);
...
string path = "/Users/vika/Projects/HW_27.10_2/HW_2.json";
...
public class Book
{
    ...
    public int PublishingHouseId; //Без { get; set; } обʼєкт не серіалізується
